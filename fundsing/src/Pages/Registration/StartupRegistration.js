                            ...
                            <div className="w-full mx-2 flex-1 svelte-1l8159u">
                                ...
                                <div className="bg-white my-2 p-1 flex border border-gray-400 rounded svelte-1l8159u">
                                    ...
                                    >
                                        ...
                                        <option>less than 20Lacs</option>
                                        <option>20lacs to 50lacs</option>
                                        <option>50lacs to 1cr</option>
                                        <option>larger than 1cr</option>
                                    </select>
                                </div>
                            </div>
                            <div className="w-full mx-2 flex-1 svelte-1l8159u">
                        ...
                        <div className="">
                            <div className="flex flex-col md:flex-row">
                                <div className="w-full mx-2 flex-1 svelte-1l8159u">
                                    <div className="font-bold h-6 mt-3 text-black text-xs leading-8 uppercase">
                                        {" "}
                                      Registration Number of startup
                                    </div>
                                    <div className="bg-white my-2 p-1 flex border border-gray-400 rounded svelte-1l8159u">
                                        <input
                                            placeholder=""
