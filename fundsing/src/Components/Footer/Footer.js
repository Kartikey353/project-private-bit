...
const Footer = () => {
    return (
        <>
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-8 mb-0">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <div className="flex items-center">
                            <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="FlowBite Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Fundsing</span>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <div className="hover:underline">Fundsing</div>
                                </li>
                                <li>
                                    <a href='mailto:kartikeybhardwaj353@gmail.com' className="hover:underline">Contact us</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://github.com/kartikey353" className="hover:underline ">Github</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href='/'  className="hover:underline">Fundsing™</a>. All Rights Reserved.
                    </span>
