    ...
    <div className="relative container py-10">
      ...
      <div className="mt-10 text-white text-sm">
        ...
        <ul className=" list-disc pl-6 mt-2">
          ...
          <li>To aid strategic development, data collection and analytics;</li>
          <li>
          ...
          <li>To audit usage of our products and services.</li>
          <li>
            Preventing any potentially illegal activity and preventing screening
            of any undesirable or abusive activity;
          </li>
          <li>
          ...
          <li>
            ...
            action when consenting by, for example, checking a tick box that We
            will provide.
          </li>
          <li>
            Under <b>Article 6(1)(a) of GDPR,</b>  you are giving your explicit
            consent to process your personal data.
          </li>
        </ul>
        <br />
        <p>
          We want to ensure that the information we collect is accurate. If your
          contact information changes, or if you wish to delete certain contact
          information from our records, please let us know by sending an email
          to support@beimagine.tech while also copying the same mail to
          legal@beimagine.tech.
        </p>
        <br />
        <p>
          If at any time you wish to “opt out” of receiving information from us,
          please let us know by sending us an email to support@beimagine.tech
          while also copying the mail to legal@beimagine.tech. Please note that
          due to lead times on certain contacts, you may continue to receive
          contacts for a short period following your “opt out” notification.
        </p>
        <br />
        <b>Log Files</b>
        <p>
        ...
        <p>
          ...
          rights with respect to information BIT holds: <br />
          <b>Under Article 15 of GDPR</b> , you have the right of access to
          information from us including the purpose of processing and categories
          of personal data concerned and right to obtain the copy;
          <br />
          <b>Under Article 16 of GDPR</b> you have the right to get your
          personal data rectified in the event of it’s inaccuracy or
          incompletion;
          <br />
          <b>Under Article 17 of GDPR</b> you have the right to request to
          delete your personal information in certain circumstances subject to
          our Retention Policy;
          <br />
          <b>Under Article 18 of GDPR</b> you have the right to request to
          restrict the processing of your data in cases such as when you have
          objected the accuracy of the data which needs verification in certain
          circumstances;
          <br />
          <b>Under Article 20 of GDPR</b> You have the right to transfer your
          ...
          <br />
          <b>Under Article 21 of GDPR,</b> you have the right to object on
          grounds relating to particular situation such as direct marketing
          purposes;
        </p>
        <br />
        <p>
          In all cases, we will need to satisfy ourselves of your identity
          before we can take action on a subject access request under the GDPR.
          We will usually require proof of identity such as a passport or
          driver’s licence.
        </p>
        <br />
        ...
        <ul className=" list-decimal pl-6 mt-2">
          <li>
            ...
            or part of the Company. Information provided will, where it is
            ...
            the Information for the purposes for which it was originally given
            to Us.
          </li>
          <li>
        ...
        <br />
        <b>Revisions to Privacy Policy:</b>
        <p>
        ...
        <p>
          ...
          mentioned below via post or by sending an email
          to hello@beimagine.tech and copying the same to legal@beimagine.tech.
        </p>
        <br />
        ...
        <p>
          ...
          or through email signed with the electronic signature to. <br />{" "}
          Grievance Redressal Officer
        </p>
        <p>Name:</p>
        <p>Email: </p>
        <p>https://www.beimagine.tech</p>
        Beyond Imagination Technologies Private Limited Suite 205 – 206, Bakshi
        House, Nehru Place, New Delhi – 110019.
      </div>
      <br />
      <p>
      ...
      <ul className=" list-decimal pl-6 mt-2">
        ...
        <li>
          The Company may reach out to you to confirm or discuss certain details
          about your complaint and issues raised. The Company shall not be
          responsible for any communication, if addressed, to any non-designated
          person in this regard. You may also contact us in case you have any
          questions / suggestions about the Policy using the contact information
          mentioned above.
        </li>
      </ul>
      <br />
      <b>Disclosure in compliance to legal obligations:</b>
      <p>
      ...
      <p>
        WE, OUR OFFICERS, DIRECTORS, EMPLOYEES, AFFILIATES AND AGENTS WILL NOT
        BE LIABLE FOR ANY ACTS OR OMISSIONS OF A THIRD PARTY, OR FOR ANY
        UNAUTHORIZED INTERCEPTION OF DATA OR BREACHES ATTRIBUTABLE IN FULL OR IN
        PART TO THE ACTS OR OMISSIONS OF THIRD PARTIES, OR FOR DAMAGES
        ASSOCIATED THAT RESULT FROM THE OPERATIONS SYSTEMS, EQUIPMENT,
        FACILITIES OR SERVICE PROVIDED BY THIRD PARTIES THAT ARE INTERCONNECTED
        WITH THE SERVERS.
      </p>
      <br />
      <b>Permission to use your company logo and name</b>
      <p>
        By registering with BIT, you grant permission to BIT to use your company
        logo and name as our client in our marketing collaterals website and
        social media posts
      </p>
    </div>
  );
